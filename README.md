...
- 학습과 구현의 성장 밸런스를 맞추기 위해 ~~잔소리 봇~~과 생활 시간표를 활용해요.
- ~~잔소리 봇~~과 생활 시간표를 통해 정해진 시간까지만 학습과 구현을 진행해요.

<br>

<details>
<summary>~~흐름 예시~~</summary>
### **흐름 예시**
...
## 1. AI로 학습과 구현의 비중을 구성해보기
과제의 키워드와 학습목표를 통해 학습과 구현의 비중을 계획해보기

### 프롬프팅 예시
```text
키워드: #IPC #레이스 컨디션 #멀티 스레드 
학습목표: 프로세스와 스레드의 차이점을 이해하고, 스레드로 병렬 처리를 할 수 있도록 구현, 
멀티 스레드 환경에서 공동 리소스에 접근하는 경우 레이스 컨디션이 발행하는 원리와 대응 방법을 구현 
...
키워드: #IPC #레이스 컨디션 #멀티 스레드 학습목표: 프로세스와 스레드의 차이점을 이해하고, 스레드로 병렬 처리를 할 수 있도록 구현, 멀티 스레드 환경에서 공동 리소스에 접근하는 경우 레이스 컨디션이 발행하는 원리와 대응 방법을 구현 이 미션의 학습과 구현의 비중을 어떻게 잡아야 할까?
