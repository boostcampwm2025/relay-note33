...
---
# 🔍 그룹 18 퀘스트 수행 경험 / 느낀점 정리

### K024_주성현
경험/느낀점 : AI에서 시간표를 짜달라고해서 그거대로 하려고했지만, 아무리 그래도 내가 원하는 방향하고 너무 달랐다. 나는 학습 8, 구현 2로 가져가면서 조금 능동적으로, 내 의지대로 시간표를 좀 바꾸어서 진행했다. 역시, AI는 날 잘 알지못한다고 느낀다.

### J058_김용휘
경험/느낀점 : AI가 짜준 두 번째 학습 비율대로 수행해보았다. 미션을 구현하기 전에 학습과 설계에 큰 비중을 두기 보다는 직접 구현해보고 부딪히는 시간을 늘리고자 하였다. 처음부터 완벽한 설계를 할 수 있지만 시간이 오래 걸리기도 하고, 정말 어려운 일이라 차라리 구현에 비중을 더 두면서 중간에 설계를 수정하면서 방향을 잡는 편이 더 구현하기 좋았다. 그리고 학습 같은 경우도 학습한 것과 실제로 구현했을 때가 다른 경우가 많았는데 이것 또한 구현에 시간을 더 많이 두고 중간중간에 학습하는 과정을 추가하니 구현하는데 도움이 됐다. 이 경험을 통해 AI를 잘 사용할 수 있다면 학습이나 구현에 효율을 더 늘릴 수 있지 않을까 생각됐다.

### J061_김윤오
경험/느낀점 : 학습과 구현사이의 균형을 어떻게 잡아야할지 항상 문제가 됐습니다. 학습만하다가 구현을 못한경우, 구현에 신경쓰느라 처음 보는 개념을 깊게 공부하지못한경우가 있었습니다. 저보다 잘 알고 있는 AI에게 비중과 방향성을 제공받아 따라 보니 막막하던 순간에 도움이 많이됐던것같습니다. 앞으로의 학습에서도 능동적으로 잘 활용한다면 학습효율이 오를것으로 기대됩니다. 

### J220_이현빈
경험/느낀점 : 미션에 따라 학습과 구현 비율을 바꿔서 진행하려고 ai에게 질문하였지만, 예상대로 나온 결과가 너무 다른점이 있었습니다. 하지만 어떤점이 중요포인트가 되는지 잘 알려주는점은 너무 좋았습니다.
